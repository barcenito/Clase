...
import org.example.centromedico.DAO.CitasDAO;
import org.example.centromedico.DAO.EspecialidadesDAO;
...
public class CitasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            fechaColumn.setCellValueFactory(cellData -> {
                Timestamp timestamp = cellData.getValue().getFecha();
                if (timestamp != null) {
            ...
            // Configurar la columna de especialidad (mucha magia...repasar lambdas a conciencia)
            ...
            // Configurar selección en la tabla (magia)
    ...
    private void crearNuevaCita() {
        try {
            ...
            nuevaCita.setFecha(Timestamp.valueOf(fechaHora));
